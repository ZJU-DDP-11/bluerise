...
if ($delete_id != null) {
	...
	mysqli_stmt_prepare($stmt, $query) or die("die in prepare !!!");
	 ...
	 */
	$result = mysqli_query($dbcon, "select * from $tb_device where id='$delete_id';") or die("finding delete_id device fail");
